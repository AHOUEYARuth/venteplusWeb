...
const ShopItem: React.FC<ShopItemProps> = ({
  ...
  return (
    <Link href="/shop/read-more">
      <div className="shop-item w-[480px] flex flex-col gap-5 border border-gray-200 rounded-md border-t-0 mt-5 relative hover:shadow-xl transition-all duration-300 cursor-pointer">
